...
VERB_OPD_YAML_SOURCE_CSV=$VERB_DATA_FOR_OPD_TESTS_DIR/verb_inflectional_forms_for_yaml.csv
NOUN_DATA_FOR_OPD_TESTS_DIR=$OJIBWE_LEXICON/OPD/for_yaml/nouns
NOUN_OPD_YAML_SOURCE_CSV=$NOUN_DATA_FOR_OPD_TESTS_DIR/noun_inflectional_forms_for_yaml.csv
