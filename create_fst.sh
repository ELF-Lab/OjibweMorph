...
make $1 MORPHOLOGYSRCDIR=$OJIBWE_MORPH LEMMAS_DIR=$OJIBWE_LEXICON/OPD SPREADSHEETS_FOR_YAML_DIR=$OJIBWE_LEXICON/OPD/for_yaml PARADIGM_MAPS_DIR=$OJIBWE_LEXICON/resources OUTPUT_DIR=$OJIBWE_MORPH/FST LANGUAGE_NAME=ojibwe
cd $OJIBWE_MORPH
if [ $1 = "check" ]; then
